...
# (key, default used by the code when the variable is unset; None = no default)
_GROUPS: list[tuple[str, list[tuple[str, str | None]]]] = [
    ("Sunshare-Konto", [
        ("SUNSHARE_USER_ACCOUNT", None), ("SUNSHARE_PASSWORD", None),
        ("SUNSHARE_DEVICE_ID", None), ("SUNSHARE_DEVICE_SN", None),
    ]),
    ("MQTT-Broker", [
        ("MQTT_HOST", None), ("MQTT_PORT", "1883"), ("MQTT_USERNAME", None),
        ("MQTT_PASSWORD", None), ("MQTT_BASE_TOPIC", "sunshare"),
    ]),
    ("Datenquelle & Netzwerk", [
